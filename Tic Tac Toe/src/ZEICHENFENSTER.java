...
public class ZEICHENFENSTER
{
    ...
    private int breite,hoehe,pos_x,pos_y;
    private boolean onframe,clicked;
    ...
    {
        this(titel, 300, 300, Color.white); 
        pos_x=0;
        pos_y=0;
        onframe=false;
        clicked=false;
...
* @param  shape  das Shape-Objekt, welches gefüllt werden soll 
    ...
    public void setzeVordergrundFarbe(Color neueFarbe)
    {
